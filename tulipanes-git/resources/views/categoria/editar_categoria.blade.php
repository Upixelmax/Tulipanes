	...
	<div class="col-10">
		<body>
			<form action="/categoria/editar" method="POST">
				...
				<input type="number" name="ID_CATEGORIA" value='{{$cat->ID_CATEGORIA}}' readonly class="form-control" id="formGroupExampleInput" >
				</div>
				<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">Nombre Producto</label>
				<input type="text" name="NOMBRE_CATEGORIA" value='{{$cat->NOMBRE_CATEGORIA}}' class="form-control" id="formGroupExampleInput" >
				</div>
